...
@:structInit @:using(_internal.Main_channel_static_extension.Channel_static_extension) class Channel {
    ...
    public function new(?_buffer:stdgo.Slice<stdgo.GoInt>, ?_lock:stdgo._internal.sync.Sync_mutex.Mutex, ?_cond:stdgo.Ref<stdgo._internal.sync.Sync_cond.Cond>, ?_closed:Bool) {
