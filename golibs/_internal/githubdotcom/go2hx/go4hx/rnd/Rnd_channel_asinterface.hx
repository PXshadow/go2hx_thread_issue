...
class Channel_asInterface {
	...
	public dynamic function close():Void
		@:_0 __self__.value.close();

	@:keep
	@:tdfield
	public dynamic function receive():stdgo.GoInt
		return @:_0 __self__.value.receive();

	@:keep
	@:tdfield
	public dynamic function send(_value:stdgo.GoInt):Void
		@:_0 __self__.value.send(_value);
	...
	var __self__:_internal.githubdotcom.go2hx.go4hx.rnd.Rnd_channelpointer.ChannelPointer;
