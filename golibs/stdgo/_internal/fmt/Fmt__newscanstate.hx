...
function _newScanState(_r:stdgo._internal.io.Io_reader.Reader, _nlIsSpace:Bool, _nlIsEnd:Bool):{ var _0 : stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>; var _1 : stdgo._internal.fmt.Fmt_t_ssave.T_ssave; } {
        ...
        {
            var __tmp__ = try {
                { _0 : (stdgo.Go.typeAssert((new stdgo.AnyInterface(_r, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.io.Io_reader.Reader", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))) : stdgo._internal.io.Io_runescanner.RuneScanner)) : stdgo._internal.io.Io_runescanner.RuneScanner), _1 : true };
            } catch(_) {
