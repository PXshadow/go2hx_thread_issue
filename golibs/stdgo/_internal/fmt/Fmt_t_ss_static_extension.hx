...
if (((_inputc != (10 : stdgo.GoInt32)) && (_inputc != (-1 : stdgo.GoInt32)) : Bool)) {
    ...
    static public function _scanOne( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>, _verb:stdgo.GoInt32, _arg:stdgo.AnyInterface):Void {
        ...
        var _err:stdgo.Error = (null : stdgo.Error);
        {
            ...
            if (_ok) {
                ...
                if (_err != null) {
                    if (new stdgo.AnyInterface(_err, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))) == (new stdgo.AnyInterface(stdgo._internal.io.Io_eof.eOF, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))))) {
        ...
        @:recv var _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss> = _s;
        {
            ...
            if (((_p >= (0 : stdgo.GoInt) : Bool) && !stdgo._internal.fmt.Fmt__hasx._hasX(_str?.__copy__()) : Bool)) {
                ...
                if (_err != null) {
                    {
                        var __tmp__ = try {
                            { _0 : (stdgo.Go.typeAssert((new stdgo.AnyInterface(_err, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))) : stdgo.Ref<stdgo._internal.strconv.Strconv_numerror.NumError>)) : stdgo.Ref<stdgo._internal.strconv.Strconv_numerror.NumError>), _1 : true };
                        } catch(_) {
    ...
    static public function _notEOF( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>):Void {
        @:recv var _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss> = _s;
        {
            ...
            if (_r == ((-1 : stdgo.GoInt32))) {
                throw new stdgo.AnyInterface(stdgo._internal.io.Io_eof.eOF, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null })));
            };
        };
        @:check2r _s.unreadRune();
    }
    ...
    static public function _free( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>, _old:stdgo._internal.fmt.Fmt_t_ssave.T_ssave):Void {
        ...
        @:check2 stdgo._internal.fmt.Fmt__ssfree._ssFree.put(new stdgo.AnyInterface(stdgo.Go.asInterface(_s), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.fmt.Fmt_t_ss.T_ss", [], stdgo._internal.internal.reflect.Reflect.GoType.structType([{ name : "_rs", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.io.Io_runescanner.RuneScanner", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }) }, optional : false }, { name : "_buf", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.fmt.Fmt_t_buffer.T_buffer", [], stdgo._internal.internal.reflect.Reflect.GoType.sliceType({ get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(uint8_kind) }), false, { get : () -> null }) }, optional : false }, { name : "_count", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(int_kind) }, optional : false }, { name : "_atEOF", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(bool_kind) }, optional : false }, { name : "_ssave", embedded : true, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.fmt.Fmt_t_ssave.T_ssave", [], stdgo._internal.internal.reflect.Reflect.GoType.structType([{ name : "_validSave", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(bool_kind) }, optional : false }, { name : "_nlIsEnd", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(bool_kind) }, optional : false }, { name : "_nlIsSpace", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(bool_kind) }, optional : false }, { name : "_argLimit", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(int_kind) }, optional : false }, { name : "_limit", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(int_kind) }, optional : false }, { name : "_maxWid", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.basic(int_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }))));
    }
    @:keep
    @:tdfield
    ...
    static public function _errorString( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>, _err:stdgo.GoString):Void {
        @:recv var _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss> = _s;
        throw new stdgo.AnyInterface(stdgo.Go.asInterface((new stdgo._internal.fmt.Fmt_t_scanerror.T_scanError(stdgo._internal.errors.Errors_new_.new_(_err?.__copy__())) : stdgo._internal.fmt.Fmt_t_scanerror.T_scanError)), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.fmt.Fmt_t_scanerror.T_scanError", [], stdgo._internal.internal.reflect.Reflect.GoType.structType([{ name : "_err", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null })));
    }
    @:keep
    @:tdfield
    static public function _error( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>, _err:stdgo.Error):Void {
        @:recv var _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss> = _s;
        throw new stdgo.AnyInterface(stdgo.Go.asInterface((new stdgo._internal.fmt.Fmt_t_scanerror.T_scanError(_err) : stdgo._internal.fmt.Fmt_t_scanerror.T_scanError)), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo._internal.fmt.Fmt_t_scanerror.T_scanError", [], stdgo._internal.internal.reflect.Reflect.GoType.structType([{ name : "_err", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null })));
    }
    @:keep
    @:tdfield
    ...
    static public function readRune( _s:stdgo.Ref<stdgo._internal.fmt.Fmt_t_ss.T_ss>):{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        ...
        } else if (new stdgo.AnyInterface(_err, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))) == (new stdgo.AnyInterface(stdgo._internal.io.Io_eof.eOF, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.Reflect.GoType.named("stdgo.Error", [], stdgo._internal.internal.reflect.Reflect.GoType.interfaceType(false, []), false, { get : () -> null }))))) {
            (@:checkr _s ?? throw "null pointer dereference")._atEOF = true;
        };
        return { _0 : _r, _1 : _size, _2 : _err };
    }
