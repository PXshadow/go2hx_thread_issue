...
function newPackage(_fset:stdgo.Ref<stdgo._internal.go.token.Token_fileset.FileSet>, _files:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo._internal.go.ast.Ast_file.File>>, _importer:stdgo._internal.go.ast.Ast_importer.Importer, _universe:stdgo.Ref<stdgo._internal.go.ast.Ast_scope.Scope>):{ var _0 : stdgo.Ref<stdgo._internal.go.ast.Ast_package.Package>; var _1 : stdgo.Error; } {
        ...
        for (__0 => _file in _files) {
            ...
            for (__1 => _obj in (@:checkr (@:checkr _file ?? throw "null pointer dereference").scope ?? throw "null pointer dereference").objects) {
        ...
        for (__1 => _file in _files) {
            ...
            for (__2 => _spec in (@:checkr _file ?? throw "null pointer dereference").imports) {
                if (_importer == null) {
                    _importErrors = true;
                    continue;
                };
                var __tmp__ = stdgo._internal.strconv.Strconv_unquote.unquote((@:checkr (@:checkr _spec ?? throw "null pointer dereference").path ?? throw "null pointer dereference").value?.__copy__()), _path:stdgo.GoString = __tmp__._0, __3:stdgo.Error = __tmp__._1;
                ...
                if (_name == (("." : stdgo.GoString))) {
                    for (__4 => _obj in (@:checkr (stdgo.Go.typeAssert(((@:checkr _pkg ?? throw "null pointer dereference").data : stdgo.Ref<stdgo._internal.go.ast.Ast_scope.Scope>)) : stdgo.Ref<stdgo._internal.go.ast.Ast_scope.Scope>) ?? throw "null pointer dereference").objects) {
            ...
            for (__3 => _ident in (@:checkr _file ?? throw "null pointer dereference").unresolved) {
