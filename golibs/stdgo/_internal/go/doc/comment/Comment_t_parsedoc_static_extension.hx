...
if (((_start >= (0 : stdgo.GoInt) : Bool) && (_i != _start) : Bool)) {
    ...
    static public function _paragraph( _d:stdgo.Ref<stdgo._internal.go.doc.comment.Comment_t_parsedoc.T_parseDoc>, _lines:stdgo.Slice<stdgo.GoString>):stdgo._internal.go.doc.comment.Comment_block.Block {
        ...
        var _iterator_3643729_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_3643847_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((0i32 : stdgo.GoInt) < (_lines.length)) {
                        _gotoNext = 3643829i32;
                    } else {
                        _gotoNext = 3643833i32;
                    };
                } else if (__value__ == (3643741i32)) {
                    _line_10 = _lines[(_iterator_3643729_9 : stdgo.GoInt)]?.__copy__();
                    {
                    ...
                    if (!_ok_12) {
                        _gotoNext = 3643781i32;
                    } else {
                        _gotoNext = 3643804i32;
                    };
                } else if (__value__ == (3643781i32)) {
                    _gotoNext = 3643971i32;
                } else if (__value__ == (3643804i32)) {
                    _defs_8 = (_defs_8.__append__(_def_11));
                    _iterator_3643729_9++;
                    _gotoNext = 3643830i32;
                } else if (__value__ == (3643829i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _lines[(0i32 : stdgo.GoInt)]?.__copy__();
                        _iterator_3643729_9 = @:binopAssign __tmp__0;
                        _line_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3643830i32;
                } else if (__value__ == (3643830i32)) {
                    if (_iterator_3643729_9 < (_lines.length)) {
                        _gotoNext = 3643741i32;
                    } else {
                        _gotoNext = 3643833i32;
                    };
                } else if (__value__ == (3643833i32)) {
                    if ((0i32 : stdgo.GoInt) < (_defs_8.length)) {
                        _gotoNext = 3643956i32;
                    } else {
                        _gotoNext = 3643960i32;
                    };
                } else if (__value__ == (3643837i32)) {
                    _iterator_3643847_13++;
                    _gotoNext = 3643957i32;
                } else if (__value__ == (3643858i32)) {
                    _def_14 = _defs_8[(_iterator_3643847_13 : stdgo.GoInt)];
                    (@:checkr _d ?? throw "null pointer dereference").doc.links = ((@:checkr _d ?? throw "null pointer dereference").doc.links.__append__(_def_14));
                    if (({
                        ...
                        _gotoNext = 3643923i32;
                    } else {
                        _gotoNext = 3643837i32;
                    };
                } else if (__value__ == (3643923i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._links[(@:checkr _def_14 ?? throw "null pointer dereference").text] = _def_14;
                    _gotoNext = 3643837i32;
                } else if (__value__ == (3643956i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _defs_8[(0i32 : stdgo.GoInt)];
                        _iterator_3643847_13 = @:binopAssign __tmp__0;
                        _def_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3643957i32;
                } else if (__value__ == (3643957i32)) {
                    if (_iterator_3643847_13 < (_defs_8.length)) {
                        _gotoNext = 3643858i32;
                    } else {
                        _gotoNext = 3643960i32;
                    };
                } else if (__value__ == (3643960i32)) {
                    return (null : stdgo._internal.go.doc.comment.Comment_block.Block);
                    _gotoNext = 3643971i32;
                } else if (__value__ == (3643971i32)) {
