...
function testForCompiler(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var __tmp__ = stdgo._internal.strings.Strings_cut.cut(_export?.__copy__(), (":" : stdgo.GoString)), _compiler:stdgo.GoString = __tmp__._0, _target:stdgo.GoString = __tmp__._1, __0:Bool = __tmp__._2;
