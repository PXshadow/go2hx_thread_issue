...
function testObjImporter(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        for (__24 => _test in stdgo._internal.go.internal.gccgoimporter.Gccgoimporter__importertests._importerTests) {
            ...
            {
                var __tmp__ = stdgo._internal.os.Os_stat.stat(_gofile?.__copy__()), __25:stdgo._internal.io.fs.Fs_fileinfo.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
