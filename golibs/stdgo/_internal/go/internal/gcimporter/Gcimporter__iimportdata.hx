...
function _iImportData(_fset:stdgo.Ref<stdgo._internal.go.token.Token_fileset.FileSet>, _imports:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>, _dataReader:stdgo.Ref<stdgo._internal.bufio.Bufio_reader.Reader>, _path:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo._internal.go.types.Types_package.Package>; var _1 : stdgo.Error; } {
        ...
        try {
            ...
            _version = (@:check2r _r._uint64() : stdgo.GoInt64);
            {
            ...
            var _sLen = (@:check2r _r._uint64() : stdgo.GoUInt64);
            var _dLen = (@:check2r _r._uint64() : stdgo.GoUInt64);
            ...
            {
                final __f__ = @:check2 _p._fake._setLines;
            ...
            var _pkgList = (new stdgo.Slice<stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>((@:check2r _r._uint64() : stdgo.GoInt).toBasic(), 0) : stdgo.Slice<stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>);
            for (_i => _ in _pkgList) {
                var _pkgPathOff = (@:check2r _r._uint64() : stdgo.GoUInt64);
                var _pkgPath = (@:check2 _p._stringAt(_pkgPathOff)?.__copy__() : stdgo.GoString);
                var _pkgName = (@:check2 _p._stringAt(@:check2r _r._uint64())?.__copy__() : stdgo.GoString);
                @:check2r _r._uint64();
                ...
                } else if (@:check2r _pkg.name() != (_pkgName)) {
                    stdgo._internal.go.internal.gcimporter.Gcimporter__errorf._errorf(("conflicting names %s and %s for package %q" : stdgo.GoString), stdgo.Go.toInterface(@:check2r _pkg.name()), stdgo.Go.toInterface(_pkgName), stdgo.Go.toInterface(_path));
                };
                ...
                {
                    var _nSyms = (@:check2r _r._uint64() : stdgo.GoUInt64);
                    while ((_nSyms > (0i64 : stdgo.GoUInt64) : Bool)) {
                        var _name = (@:check2 _p._stringAt(@:check2r _r._uint64()).__copy__() : stdgo.GoString);
_nameIndex[_name] = @:check2r _r._uint64();
                        _nSyms--;
                    };
                };
            ...
            for (_name => _ in (_p._pkgIndex[_localpkg] ?? (null : stdgo.GoMap<stdgo.GoString, stdgo.GoUInt64>))) {
                _names = (_names.__append__(_name?.__copy__()));
            };
            stdgo._internal.sort.Sort_strings.strings(_names);
            for (__0 => _name in _names) {
                @:check2 _p._doDecl(_localpkg, _name?.__copy__());
            };
            for (__1 => _d in _p._later) {
                @:check2r _d._t.setConstraint(_d._constraint);
            };
            for (__2 => _typ in _p._interfaceList) {
                @:check2r _typ.complete();
            };
            var _list = ((null : stdgo.Slice<stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>).__append__(...((_pkgList.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>) : Array<stdgo.Ref<stdgo._internal.go.types.Types_package.Package>>)));
            ...
            @:check2r _localpkg.setImports(_list);
            @:check2r _localpkg.markComplete();
            {
