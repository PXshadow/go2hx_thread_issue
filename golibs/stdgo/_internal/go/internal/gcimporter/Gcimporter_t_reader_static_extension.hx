            ...
            var _tag = (@:check2r _r.code((19 : stdgo._internal.internal.pkgbits.Pkgbits_syncmarker.SyncMarker)) : stdgo._internal.internal.pkgbits.Pkgbits_codetype.CodeType);
            {
                ...
                if (__value__ == ((0 : stdgo._internal.internal.pkgbits.Pkgbits_codetype.CodeType))) {
                    ...
                    if ((_targs.length) != ((0 : stdgo.GoInt))) {
                        var __tmp__ = stdgo._internal.go.types.Types_instantiate.instantiate((@:checkr (@:checkr _r ?? throw "null pointer dereference")._p ?? throw "null pointer dereference")._ctxt, @:check2r _name.type(), _targs, false), _t:stdgo._internal.go.types.Types_type_.Type_ = __tmp__._0, __0:stdgo.Error = __tmp__._1;
                        return _res = _t;
                    };
