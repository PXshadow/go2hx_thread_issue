                ...
                if ((@:checkr _p ?? throw "null pointer dereference")._tok == ((4 : stdgo._internal.go.token.Token_token.Token))) {
                    ...
                    };
                    {
                        ...
                        if ((({
                            final value = _pname;
                            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
                        }) && (((_ptype != null) || ((@:checkr _p ?? throw "null pointer dereference")._tok != (55 : stdgo._internal.go.token.Token_token.Token)) : Bool)) : Bool)) {
                        ...
                        if (_ok) {
                            ...
                            while ((_ok && (_dir == (1 : stdgo._internal.go.ast.Ast_chandir.ChanDir)) : Bool)) {
                                ...
                                };
                                {
                                    ...
                                    (@:checkr _typ ?? throw "null pointer dereference").begin = @:binopAssign __tmp__1;
                                    (@:checkr _typ ?? throw "null pointer dereference").arrow = @:binopAssign __tmp__2;
                                };
                                {
                                    ...
                                    (@:checkr _typ ?? throw "null pointer dereference").dir = @:binopAssign __tmp__1;
                                };
                                {
                                    var __tmp__ = try {
                    ...
                    stdgo._internal.go.parser.Parser__incnestlev._incNestLev(_p);
{
    ...
    static public function _parseInterfaceType( _p:stdgo.Ref<stdgo._internal.go.parser.Parser_t_parser.T_parser>):stdgo.Ref<stdgo._internal.go.ast.Ast_interfacetype.InterfaceType> {
        ...
        var __deferstack__:Array<{ var ran : Bool; var f : Void -> Void; }> = [];
        try {
            var _f_3:stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field> = (null : stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>);
            var _parseElementsBreak = false;
            var _pos_0:stdgo._internal.go.token.Token_pos.Pos = ((0 : stdgo.GoInt) : stdgo._internal.go.token.Token_pos.Pos);
            var _rbrace_9:stdgo._internal.go.token.Token_pos.Pos = ((0 : stdgo.GoInt) : stdgo._internal.go.token.Token_pos.Pos);
            var _comment_8:stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup> = (null : stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup>);
            var _typ_7:stdgo._internal.go.ast.Ast_expr.Expr = (null : stdgo._internal.go.ast.Ast_expr.Expr);
            var _t_6:stdgo._internal.go.ast.Ast_expr.Expr = (null : stdgo._internal.go.ast.Ast_expr.Expr);
            var _typ_4:stdgo._internal.go.ast.Ast_expr.Expr = (null : stdgo._internal.go.ast.Ast_expr.Expr);
            var _list_2:stdgo.Slice<stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>> = (null : stdgo.Slice<stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>>);
            var _lbrace_1:stdgo._internal.go.token.Token_pos.Pos = ((0 : stdgo.GoInt) : stdgo._internal.go.token.Token_pos.Pos);
            var _comment_5:stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup> = (null : stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup>);
            var _gotoNext = 0i32;
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        if ((@:checkr _p ?? throw "null pointer dereference")._trace) {
                            _gotoNext = 3853759i32;
                        } else {
                            _gotoNext = 3853804i32;
                        };
                    } else if (__value__ == (3853759i32)) {
                        {
                        ...
                        _gotoNext = 3853804i32;
                    } else if (__value__ == (3853804i32)) {
                        _pos_0 = @:check2r _p._expect((76 : stdgo._internal.go.token.Token_token.Token));
                        _lbrace_1 = @:check2r _p._expect((51 : stdgo._internal.go.token.Token_token.Token));
                        _gotoNext = 3853896i32;
                    } else if (__value__ == (3853896i32)) {
                        0i32;
                        _parseElementsBreak = false;
                        _gotoNext = 3853912i32;
                    } else if (__value__ == (3853912i32)) {
                        if (!_parseElementsBreak) {
                            _gotoNext = 3853916i32;
                        } else {
                            _gotoNext = 3854621i32;
                        };
                    } else if (__value__ == (3853916i32)) {
                        ...
                        if ((@:checkr _p ?? throw "null pointer dereference")._tok == ((4 : stdgo._internal.go.token.Token_token.Token))) {
                            ...
                            _gotoNext = 3854108i32;
                        } else {
                            _gotoNext = 3854260i32;
                        };
                    } else if (__value__ == (3853931i32)) {
                        _f_3 = @:check2r _p._parseMethodSpec();
                        if ((@:checkr _f_3 ?? throw "null pointer dereference").names == null) {
                            _gotoNext = 3854007i32;
                        } else {
                            _gotoNext = 3854053i32;
                        };
                    } else if (__value__ == (3854007i32)) {
                        (@:checkr _f_3 ?? throw "null pointer dereference").type = @:check2r _p._embeddedElem((@:checkr _f_3 ?? throw "null pointer dereference").type);
                        _gotoNext = 3854053i32;
                    } else if (__value__ == (3854053i32)) {
                        (@:checkr _f_3 ?? throw "null pointer dereference").comment = @:check2r _p._expectSemi();
                        _list_2 = (_list_2.__append__(_f_3));
                        _gotoNext = 3853912i32;
                    } else if (__value__ == (3854108i32)) {
                        _typ_4 = @:check2r _p._embeddedElem((null : stdgo._internal.go.ast.Ast_expr.Expr));
                        _comment_5 = @:check2r _p._expectSemi();
                        _list_2 = (_list_2.__append__((stdgo.Go.setRef(({ type : _typ_4, comment : _comment_5 } : stdgo._internal.go.ast.Ast_field.Field)) : stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>)));
                        _gotoNext = 3853912i32;
                    } else if (__value__ == (3854260i32)) {
                        {
                            _t_6 = @:check2r _p._tryIdentOrType();
                            if (_t_6 != null) {
                                _gotoNext = 3854309i32;
                            } else {
                                _gotoNext = 3854445i32;
                            };
                        };
                    } else if (__value__ == (3854309i32)) {
                        _typ_7 = @:check2r _p._embeddedElem(_t_6);
                        _comment_8 = @:check2r _p._expectSemi();
                        _list_2 = (_list_2.__append__((stdgo.Go.setRef(({ type : _typ_7, comment : _comment_8 } : stdgo._internal.go.ast.Ast_field.Field)) : stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>)));
                        _gotoNext = 3853912i32;
                    } else if (__value__ == (3854445i32)) {
                        _gotoNext = 3854445i32;
                        _parseElementsBreak = true;
                        _gotoNext = 3853912i32;
                    } else if (__value__ == (3854621i32)) {
                        _rbrace_9 = @:check2r _p._expect((56 : stdgo._internal.go.token.Token_token.Token));
                        {
                            final __ret__:stdgo.Ref<stdgo._internal.go.ast.Ast_interfacetype.InterfaceType> = (stdgo.Go.setRef(({ interface_ : _pos_0, methods : (stdgo.Go.setRef(({ opening : _lbrace_1, list : _list_2, closing : _rbrace_9 } : stdgo._internal.go.ast.Ast_fieldlist.FieldList)) : stdgo.Ref<stdgo._internal.go.ast.Ast_fieldlist.FieldList>) } : stdgo._internal.go.ast.Ast_interfacetype.InterfaceType)) : stdgo.Ref<stdgo._internal.go.ast.Ast_interfacetype.InterfaceType>);
                            for (defer in __deferstack__) {
                                if (defer.ran) continue;
                                defer.ran = true;
                                defer.f();
                            ...
                            if ((@:checkr _p ?? throw "null pointer dereference")._tok == ((50 : stdgo._internal.go.token.Token_token.Token))) {
                                ...
                                (@:checkr _p ?? throw "null pointer dereference")._exprLev--;
                                {
                                    ...
                                    if (((({
                                        final value = _name0;
                                        (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
                                    }) && (@:checkr _p ?? throw "null pointer dereference")._tok != ((52 : stdgo._internal.go.token.Token_token.Token)) : Bool) && ((@:checkr _p ?? throw "null pointer dereference")._tok != (55 : stdgo._internal.go.token.Token_token.Token)) : Bool)) {
                                        @:check2r _p._parseParameterList(_name0, (null : stdgo._internal.go.ast.Ast_expr.Expr), (55 : stdgo._internal.go.token.Token_token.Token));
                                        @:check2r _p._expect((55 : stdgo._internal.go.token.Token_token.Token));
    ...
    static public function _parseParameterList( _p:stdgo.Ref<stdgo._internal.go.parser.Parser_t_parser.T_parser>, _name0:stdgo.Ref<stdgo._internal.go.ast.Ast_ident.Ident>, _typ0:stdgo._internal.go.ast.Ast_expr.Expr, _closing:stdgo._internal.go.token.Token_token.Token):stdgo.Slice<stdgo.Ref<stdgo._internal.go.ast.Ast_field.Field>> {
        ...
        try {
            ...
            while ((({
                final value = _name0;
                (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
            }) || ((@:checkr _p ?? throw "null pointer dereference")._tok != (_closing) && (@:checkr _p ?? throw "null pointer dereference")._tok != ((1 : stdgo._internal.go.token.Token_token.Token)) : Bool) : Bool)) {
                        ...
                        var _par = (stdgo.Go.setRef(_list[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.go.parser.Parser_t_field.T_field>);
{
                    ...
                    while ((_i >= (0 : stdgo.GoInt) : Bool)) {
                        {
                            ...
                            if ((@:checkr _par ?? throw "null pointer dereference")._typ != null) {
                                ...
                                if (({
                                    final value = (@:checkr _par ?? throw "null pointer dereference")._name;
                                    (value == null || (value : Dynamic).__nil__);
                                })) {
                                    _ok = false;
    ...
    static public function _safePos( _p:stdgo.Ref<stdgo._internal.go.parser.Parser_t_parser.T_parser>, _pos:stdgo._internal.go.token.Token_pos.Pos):stdgo._internal.go.token.Token_pos.Pos {
        ...
        try {
            ...
            @:check2r (@:checkr _p ?? throw "null pointer dereference")._file.offset(_pos);
            {
