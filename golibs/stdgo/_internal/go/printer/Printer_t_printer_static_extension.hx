...
@:keep @:allow(stdgo._internal.go.printer.Printer.T_printer_asInterface) class T_printer_static_extension {
    ...
    static public function _printNode( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>, _node:stdgo.AnyInterface):stdgo.Error {
        ...
        var _iterator_4895347_23:stdgo.GoInt = (0 : stdgo.GoInt);
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        if (_ok_2) {
                            _gotoNext = 4893726i32;
                        } else {
                            _gotoNext = 4893781i32;
                        };
                    };
                } else if (__value__ == (4893726i32)) {
                    ...
                    _gotoNext = 4893781i32;
                } else if (__value__ == (4893781i32)) {
                    if (_comments_0 != null) {
                        _gotoNext = 4893800i32;
                    } else {
                        {
                            var __tmp__ = try {
                        ...
                        if (_ok_13) {
                            _gotoNext = 4894614i32;
                        } else {
                            _gotoNext = 4894730i32;
                        };
                    };
                } else if (__value__ == (4893800i32)) {
                    {
                        var __tmp__ = try {
                    ...
                    if (!_ok_4) {
                        _gotoNext = 4893900i32;
                    } else {
                        _gotoNext = 4893928i32;
                    };
                } else if (__value__ == (4893900i32)) {
                    _gotoNext = 4895571i32;
                } else if (__value__ == (4893928i32)) {
                    _beg_5 = _n_3.pos();
                    _end_6 = _n_3.end();
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4894182i32;
                        } else {
                            _gotoNext = 4894209i32;
                        };
                    };
                } else if (__value__ == (4894182i32)) {
                    _beg_5 = @:check2r _doc_7.pos();
                    _gotoNext = 4894209i32;
                } else if (__value__ == (4894209i32)) {
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4894249i32;
                        } else {
                            _gotoNext = 4894382i32;
                        };
                    };
                } else if (__value__ == (4894249i32)) {
                    {
                        _e_9 = @:check2r _com_8.end();
                        if ((_e_9 > _end_6 : Bool)) {
                            _gotoNext = 4894281i32;
                        } else {
                            _gotoNext = 4894382i32;
                        };
                    };
                } else if (__value__ == (4894281i32)) {
                    _end_6 = _e_9;
                    _gotoNext = 4894382i32;
                } else if (__value__ == (4894382i32)) {
                    _i_10 = (0 : stdgo.GoInt);
                    0i32;
                    _gotoNext = 4894391i32;
                } else if (__value__ == (4894391i32)) {
                    if (((_i_10 < (_comments_0.length) : Bool) && (@:check2r _comments_0[(_i_10 : stdgo.GoInt)].end() < _beg_5 : Bool) : Bool)) {
                        _gotoNext = 4894440i32;
                    } else {
                        _gotoNext = 4894455i32;
                    };
                } else if (__value__ == (4894440i32)) {
                    _i_10++;
                    _gotoNext = 4894391i32;
                } else if (__value__ == (4894455i32)) {
                    _j_11 = _i_10;
                    0i32;
                    _gotoNext = 4894464i32;
                } else if (__value__ == (4894464i32)) {
                    if (((_j_11 < (_comments_0.length) : Bool) && (@:check2r _comments_0[(_j_11 : stdgo.GoInt)].pos() < _end_6 : Bool) : Bool)) {
                        _gotoNext = 4894513i32;
                    } else {
                        _gotoNext = 4894528i32;
                    };
                } else if (__value__ == (4894513i32)) {
                    _j_11++;
                    _gotoNext = 4894464i32;
                } else if (__value__ == (4894528i32)) {
                    if ((_i_10 < _j_11 : Bool)) {
                        _gotoNext = 4894537i32;
                    } else {
                        _gotoNext = 4894730i32;
                    };
                } else if (__value__ == (4894537i32)) {
                    ...
                    0i32;
                    _gotoNext = 4894855i32;
                } else if (__value__ == (4894855i32)) {
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.go.ast.Ast_expr.Expr))) {
                            ...
                            _n_20 = _n;
                            _gotoNext = 4895486i32;
                        } else {
                            var _n:stdgo.AnyInterface = __type__?.__underlying__();
                            _n_21 = _n;
                            _gotoNext = 4895515i32;
                        };
                    };
                } else if (__value__ == (4894882i32)) {
                    @:check2r _p._expr(_n_14);
                    _n_14;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4894910i32)) {
                    {
                        {
                            var __tmp__ = try {
                        ...
                        if (_ok_22) {
                            _gotoNext = 4895086i32;
                        } else {
                            _gotoNext = 4895110i32;
                        };
                    };
                } else if (__value__ == (4895086i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._indent = (1 : stdgo.GoInt);
                    _gotoNext = 4895110i32;
                } else if (__value__ == (4895110i32)) {
                    @:check2r _p._stmt(_n_15, false);
                    _n_15;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895128i32)) {
                    @:check2r _p._decl(_n_16);
                    _n_16;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895156i32)) {
                    @:check2r _p._spec(_n_17, (1 : stdgo.GoInt), false);
                    _n_17;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895194i32)) {
                    if ((0i32 : stdgo.GoInt) < (_n_18.length)) {
                        _gotoNext = 4895422i32;
                    } else {
                        _gotoNext = 4895427i32;
                    };
                } else if (__value__ == (4895339i32)) {
                    _iterator_4895347_23++;
                    _gotoNext = 4895423i32;
                } else if (__value__ == (4895355i32)) {
                    _s_24 = _n_18[(_iterator_4895347_23 : stdgo.GoInt)];
                    {
                        {
                            var __tmp__ = try {
                        ...
                        if (_ok_25) {
                            _gotoNext = 4895397i32;
                        } else {
                            _gotoNext = 4895339i32;
                        };
                    };
                } else if (__value__ == (4895397i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._indent = (1 : stdgo.GoInt);
                    _gotoNext = 4895339i32;
                } else if (__value__ == (4895422i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _n_18[(0i32 : stdgo.GoInt)];
                        _iterator_4895347_23 = @:binopAssign __tmp__0;
                        _s_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4895423i32;
                } else if (__value__ == (4895423i32)) {
                    if (_iterator_4895347_23 < (_n_18.length)) {
                        _gotoNext = 4895355i32;
                    } else {
                        _gotoNext = 4895427i32;
                    };
                } else if (__value__ == (4895427i32)) {
                    @:check2r _p._stmtList(_n_18, (0 : stdgo.GoInt), false);
                    _n_18;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895452i32)) {
                    @:check2r _p._declList(_n_19);
                    _n_19;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895486i32)) {
                    @:check2r _p._file(_n_20);
                    _n_20;
                    _gotoNext = 4895548i32;
                } else if (__value__ == (4895515i32)) {
                    _gotoNext = 4895571i32;
                } else if (__value__ == (4895548i32)) {
                    return (@:checkr _p ?? throw "null pointer dereference")._sourcePosErr;
                    _gotoNext = 4895571i32;
                } else if (__value__ == (4895571i32)) {
    ...
    static public function _intersperseComments( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>, _next:stdgo._internal.go.token.Token_position.Position, _tok:stdgo._internal.go.token.Token_token.Token):{ var _0 : Bool; var _1 : Bool; } {
        ...
        while (@:check2r _p._commentBefore(_next?.__copy__())) {
            ...
            if ((((@:checkr _p ?? throw "null pointer dereference")._lastTok != ((75 : stdgo._internal.go.token.Token_token.Token)) && @:check2r _p._posFor(@:check2r (@:checkr _p ?? throw "null pointer dereference")._commentInfo._comment.pos()).column == ((1 : stdgo.GoInt)) : Bool) && (stdgo.Go.toInterface(@:check2r _p._posFor((@:check2r (@:checkr _p ?? throw "null pointer dereference")._commentInfo._comment.end() + (1 : stdgo._internal.go.token.Token_pos.Pos) : stdgo._internal.go.token.Token_pos.Pos))) == stdgo.Go.toInterface(_next)) : Bool)) {
                ...
                if (((((@:checkr (@:checkr _p ?? throw "null pointer dereference")._commentInfo._comment ?? throw "null pointer dereference").list.length) > (0 : stdgo.GoInt) : Bool) && (_list.length == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    @:check2r _p._nextComment();
                    return @:check2r _p._writeCommentSuffix(false);
                };
            };
            for (__0 => _c in _list) {
        ...
        if (({
            ...
            return @:check2r _p._writeCommentSuffix(_needsLinebreak);
        };
    ...
    static public function _containsLinebreak( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>):Bool {
        @:recv var _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer> = _p;
        for (__0 => _ch in (@:checkr _p ?? throw "null pointer dereference")._wsbuf) {
    ...
    static public function _commentSizeBefore( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>, _next:stdgo._internal.go.token.Token_position.Position):stdgo.GoInt {
        ...
        try {
            ...
            while (@:check2r _p._commentBefore(_next?.__copy__())) {
                for (__0 => _c in (@:checkr (@:checkr _p ?? throw "null pointer dereference")._commentInfo._comment ?? throw "null pointer dereference").list) {
        ...
        @:check2r _p._setPos(_expr.pos());
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.go.ast.Ast_badexpr.BadExpr>))) {
                ...
                var _x:stdgo.Ref<stdgo._internal.go.ast.Ast_parenexpr.ParenExpr> = __type__ == null ? (null : stdgo.Ref<stdgo._internal.go.ast.Ast_parenexpr.ParenExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo._internal.go.ast.Ast_parenexpr.ParenExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo._internal.go.ast.Ast_parenexpr.ParenExpr>) : __type__.__underlying__().value;
                {
                    ...
                    }, __0 = __tmp__._0, _hasParens = __tmp__._1;
                    if (_hasParens) {
...
var _closeTok = __1, _openTok = __0;
    ...
    static public function _fixGoBuildLines( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>):Void {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__value__ == ((0 : stdgo.GoInt))) {
                        for (__0 => _pos in (@:checkr _p ?? throw "null pointer dereference")._plusBuild) {
        ...
        if (_x == null) {
            for (__0 => _pos in (@:checkr _p ?? throw "null pointer dereference")._goBuild) {
                _block = (_block.__append__(...(@:check2r _p._lineAt(_pos) : Array<stdgo.GoUInt8>)));
            };
            for (__1 => _pos in (@:checkr _p ?? throw "null pointer dereference")._plusBuild) {
                _block = (_block.__append__(...(@:check2r _p._lineAt(_pos) : Array<stdgo.GoUInt8>)));
            };
        } else {
