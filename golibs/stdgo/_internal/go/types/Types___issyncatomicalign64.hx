...
function __IsSyncAtomicAlign64(t:stdgo._internal.go.types.Types_type_.Type_):Bool {
        ...
        return ((@:check2r _obj.name() == (("align64" : stdgo.GoString)) && ({
            final value = @:check2r _obj.pkg();
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        }) : Bool) && (((@:check2r @:check2r _obj.pkg().path() == ("sync/atomic" : stdgo.GoString)) || (@:check2r @:check2r _obj.pkg().path() == ("runtime/internal/atomic" : stdgo.GoString)) : Bool)) : Bool);
    }
