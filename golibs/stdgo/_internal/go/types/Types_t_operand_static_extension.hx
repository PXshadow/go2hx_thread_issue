        ...
        if (stdgo._internal.go.types.Types__isuntyped._isUntyped(vu)) {
            ...
            if (({
                ...
                return { _0 : @:check2r tp._is(function(_t:stdgo.Ref<stdgo._internal.go.types.Types_t_term.T_term>):Bool {
                    ...
                    var __tmp__ = @:check2r _check._implicitTypeAndValue(_x, (@:checkr _t ?? throw "null pointer dereference")._typ), _newType:stdgo._internal.go.types.Types_type_.Type_ = __tmp__._0, __2:stdgo._internal.go.constant.Constant_value.Value = __tmp__._1, __3:stdgo._internal.internal.types.errors.Errors_code.Code = __tmp__._2;
                    return _newType != null;
                }), _1 : (23 : stdgo._internal.internal.types.errors.Errors_code.Code) };
            };
            var __tmp__ = @:check2r _check._implicitTypeAndValue(_x, t), _newType:stdgo._internal.go.types.Types_type_.Type_ = __tmp__._0, __2:stdgo._internal.go.constant.Constant_value.Value = __tmp__._1, __3:stdgo._internal.internal.types.errors.Errors_code.Code = __tmp__._2;
                    ...
                    if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.go.types.Types_array_.Array_>))) {
                        ...
                        if (stdgo._internal.go.types.Types_identical.identical(@:check2r _s.elem(), @:check2r _a.elem())) {
                            if ((({
                                final value = _check;
                                (value == null || (value : Dynamic).__nil__);
                            }) || @:check2r _check._allowVersion((@:checkr _check ?? throw "null pointer dereference")._environment._sig._recv._object._pkg, stdgo.Go.asInterface(_x), stdgo._internal.go.types.Types__go1_20._go1_20?.__copy__()) : Bool)) {
                                return true;
                            };
                            if (_cause != null) {
                            ...
                            if (({
                                ...
                                if (stdgo._internal.go.types.Types_identical.identical(@:check2r _s.elem(), @:check2r _a.elem())) {
                                    if ((({
                                        final value = _check;
                                        (value == null || (value : Dynamic).__nil__);
                                    }) || @:check2r _check._allowVersion((@:checkr _check ?? throw "null pointer dereference")._environment._sig._recv._object._pkg, stdgo.Go.asInterface(_x), stdgo._internal.go.types.Types__go1_17._go1_17?.__copy__()) : Bool)) {
                                        return true;
                                    };
                                    if (_cause != null) {
