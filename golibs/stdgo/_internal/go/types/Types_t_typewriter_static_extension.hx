    ...
    static public function _typeSet( _w:stdgo.Ref<stdgo._internal.go.types.Types_t_typewriter.T_typeWriter>, _s:stdgo.Ref<stdgo._internal.go.types.Types_t__typeset.T__TypeSet>):Void {
        ...
        if ((@:checkr _s ?? throw "null pointer dereference")._terms._isAll()) {} else if ((@:checkr _s ?? throw "null pointer dereference")._terms._isEmpty()) {
            ...
            for (__1 => _term in (@:checkr _s ?? throw "null pointer dereference")._terms) {
                ...
                _termHashes = (_termHashes.__append__((@:check2 _buf.string() : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>);
            };
                    ...
                    while (__bool__) {
                        ...
                        if (__type__ == null) {
                            ...
                            if (({
                                ...
                                for (__0 => _m in (@:checkr _t ?? throw "null pointer dereference")._methods) {
                                    if (!_first) {
                                        @:check2r _w._byte((59 : stdgo.GoUInt8));
                                    };
                                    _first = false;
                                ...
                                for (__1 => _typ in (@:checkr _t ?? throw "null pointer dereference")._embeddeds) {
                                    if (!_first) {
                                        @:check2r _w._byte((59 : stdgo.GoUInt8));
                                    };
                                    _first = false;
                            ...
                            if (({
                                ...
                                final value = (@:checkr _w ?? throw "null pointer dereference")._ctxt;
                                (value == null || (value : Dynamic).__nil__);
                            }) && (@:check2r @:check2r _t.typeParams().len() != (0 : stdgo.GoInt)) : Bool)) {
                            ...
                            };
                            {
                                ...
                                if ((_i >= (0 : stdgo.GoInt) : Bool)) {
                                    ...
                                    if ((({
                                        final value = (@:checkr _w ?? throw "null pointer dereference")._ctxt;
                                        (value == null || (value : Dynamic).__nil__);
                                    }) && (@:check2r stdgo._internal.go.types.Types_universe.universe.lookup((@:checkr (@:checkr _t ?? throw "null pointer dereference")._obj ?? throw "null pointer dereference")._object._name?.__copy__()) != null) : Bool)) {
