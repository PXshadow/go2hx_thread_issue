...
class AWriter_asInterface {
    @:keep
    @:tdfield
    public dynamic function addIP(_v4:stdgo.GoArray<stdgo.GoUInt8>):Void @:_0 __self__.value.addIP(_v4);
    @:embedded
    ...
    var __self__ : stdgo._internal.net.Net_awriterpointer.AWriterPointer;
