...
@:structInit @:using(stdgo._internal.net.Net_t_localpacketserver_static_extension.T_localPacketServer_static_extension) class T_localPacketServer {
    @:embedded
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_readFrom():stdgo.Slice<stdgo.GoUInt8> -> { var _0 : stdgo.GoInt; var _1 : stdgo._internal.net.Net_addr.Addr; var _2 : stdgo.Error; } return @:check31 (this.new ?? throw "null pointer dereference").readFrom;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_writeTo():(stdgo.Slice<stdgo.GoUInt8>, stdgo._internal.net.Net_addr.Addr) -> { var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return @:check31 (this.new ?? throw "null pointer dereference").writeTo;
    public function __copy__() {
        return new T_localPacketServer(packetConn);
    }
}
