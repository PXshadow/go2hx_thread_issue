...
@:structInit @:using(stdgo._internal.net.Net_t_tcpconnwithoutwriteto_static_extension.T_tcpConnWithoutWriteTo_static_extension) class T_tcpConnWithoutWriteTo {
    @:embedded
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_readFrom():stdgo._internal.io.Io_reader.Reader -> { var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return @:check32 this.new.readFrom;
    ...
    public function __copy__() {
        return new T_tcpConnWithoutWriteTo(tCPConn);
    }
}
